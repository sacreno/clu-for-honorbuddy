...
namespace Clu.Helpers
{
    ...
    public static class Poisons
    {
        ...
        {
            get {
                return StyxWoW.Me.Inventory.Equipped.MainHand != null && StyxWoW.Me.Inventory.Equipped.MainHand.TemporaryEnchantment.Id == 0 && StyxWoW.Me.Inventory.Equipped.MainHand.ItemInfo.WeaponClass != WoWItemWeaponClass.FishingPole;
            }
        }
        ...
        {
            get {
                return StyxWoW.Me.Inventory.Equipped.OffHand != null && StyxWoW.Me.Inventory.Equipped.OffHand.TemporaryEnchantment.Id == 0;
            }
        }

        public static bool ThrownNeedsPoison
        {
            get {
                return StyxWoW.Me.Inventory.Equipped.Ranged != null && StyxWoW.Me.Inventory.Equipped.Ranged.IsThrownWeapon && StyxWoW.Me.Inventory.Equipped.Ranged.TemporaryEnchantment.Id == 0;
            }
        }
        ...
        {
            get {
                switch (CLUSettings.Instance.Rogue.MHPoison) {
        ...
        {
            get {
                switch (CLUSettings.Instance.Rogue.OHPoison) {
                case PoisonType.Instant:
                    return StyxWoW.Me.CarriedItems.Where(i => InstantPoisons.Contains(i.Entry)).OrderByDescending(i => i.Entry).FirstOrDefault();
                case PoisonType.Crippling:
                    return StyxWoW.Me.CarriedItems.Where(i => CripplingPoisons.Contains(i.Entry)).OrderByDescending(i => i.Entry).FirstOrDefault();
        ...
        {
            get {
                switch (CLUSettings.Instance.Rogue.ThrownPoison) {
                case PoisonType.Instant:
                    return StyxWoW.Me.CarriedItems.Where(i => InstantPoisons.Contains(i.Entry)).OrderByDescending(i => i.Entry).FirstOrDefault();
                case PoisonType.Crippling:
                    return StyxWoW.Me.CarriedItems.Where(i => CripplingPoisons.Contains(i.Entry)).OrderByDescending(i => i.Entry).FirstOrDefault();
