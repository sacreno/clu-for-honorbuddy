            ...
            get
            {
                return new PrioritySelector(
                    // Pause Rotation
                           ...
                           Spell.CastSpell("Chi Brew", ret => TalentManager.HasTalent(9) && Chi <= 0 && Buff.PlayerHasBuff("Tigereye Brew Use") && Me.CurrentEnergy <= 50, "Chi Brew"),
                           ...
                           Spell.CastSpell("Blackout Kick", ret => Chi >= 2 && Spell.SpellOnCooldown("Fists of Fury") || Chi >= 3 && Me.CurrentEnergy <= 50 && Me.IsMoving && !Spell.SpellOnCooldown("Fists of Fury") || Chi >= 3 && Me.CurrentEnergy > 50, "Blackout Kick"),
                           Spell.CastSpell("Jab", ret => TalentManager.HasTalent(8) && Chi <= 3, "Jab"),
                           Spell.CastSpell("Jab", ret => Chi <= 2, "Jab"),
