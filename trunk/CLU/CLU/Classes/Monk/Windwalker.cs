        ...
        public override Composite SingleRotation
        {
            get
            {
                return new PrioritySelector(
                    ...
                    Spell.CastSpell("Rushing Jade Wind", ret => TalentManager.HasTalent(16) && Me.HasMyAura("Tiger Power") && Buff.TargetHasDebuff("Rising Sun Kick") && Me.CurrentEnergy <= 80, "Rushing Jade Wind"))),
                    ...
                    //Spell.CastAreaSpell("Fists of Fury", 8, false, 4, 0.0, 0.0, ret => true, "Fists of Fury"),
                        ...
                        Spell.CastSpell("Tiger Palm", ret => Buff.TargetHasDebuff("Rising Sun Kick") && (!Me.HasMyAura("Tiger Power") || Me.HasMyAura("Tiger Power") && Buff.PlayerBuffTimeLeft("Tiger Power") < 3), "Tiger Palm"),
                        Spell.CastSpell("Blackout Kick", ret => Buff.TargetHasDebuff("Rising Sun Kick") && Me.HasMyAura("Tiger Power") && Buff.PlayerBuffTimeLeft("Tiger Power") >= 3 && Me.CurrentEnergy < 40, "Blackout Kick"))),
                    ...
                    new Decorator(
                        ...
                        Spell.CastSpell("Tiger Palm", ret => Me.HasMyAura("Tiger Power") && Buff.PlayerBuffTimeLeft("Tiger Power") < 3, "Refresh Tiger Power"),
                        ...
                        Spell.CastSpell("Tiger Palm", ret => !Me.HasMyAura("Tiger Power"), "Tiger Palm"),
                        Spell.CastSpell("Fists of Fury", ret => !Me.IsMoving && !Buff.PlayerHasActiveBuff("Energizing Brew") && Me.CurrentEnergy <= 60 && Me.HasMyAura("Tiger Power") && Buff.PlayerBuffTimeLeft("Tiger Power") > 5 && Spell.SpellCooldown("Rising Sun Kick").TotalSeconds >= 2, "Fists of Fury"),
                        Spell.CastSpell("Blackout Kick", ret => Buff.PlayerHasActiveBuff("Combo Breaker: Blackout Kick") && Spell.SpellOnCooldown("Rising Sun Kick") && Me.HasMyAura("Tiger Power") && Buff.PlayerBuffTimeLeft("Tiger Power") >= 3 && Me.CurrentEnergy < 80, "Combo Breaker: Blackout Kick"),
                        ...
                        Spell.CastSpell("Blackout Kick", ret => Chi <= 4 && Spell.SpellOnCooldown("Fists of Fury") && Spell.SpellOnCooldown("Rising Sun Kick") && Me.CurrentEnergy >= 70 && Me.HasMyAura("Tiger Power") && Buff.PlayerBuffTimeLeft("Tiger Power") >= 3 || Chi <= 4 && Spell.SpellOnCooldown("Fists of Fury") && Spell.SpellCooldown("Rising Sun Kick").TotalSeconds >= 2 && Me.CurrentEnergy >= 20 && Me.HasMyAura("Tiger Power") && Buff.PlayerBuffTimeLeft("Tiger Power") >= 3 || !Spell.SpellOnCooldown("Fists of Fury") && Spell.SpellOnCooldown("Rising Sun Kick") && Me.CurrentEnergy > 60 && Me.HasMyAura("Tiger Power") && Buff.PlayerBuffTimeLeft("Tiger Power") >= 3 && Chi >= 3 || !Spell.SpellOnCooldown("Fists of Fury") && Spell.SpellOnCooldown("Rising Sun Kick") && Me.CurrentEnergy <= 60 && Me.IsMoving && Me.HasMyAura("Tiger Power") && Buff.PlayerBuffTimeLeft("Tiger Power") >= 3 || !Spell.SpellOnCooldown("Fists of Fury") && Spell.SpellOnCooldown("Rising Sun Kick") && Me.CurrentEnergy <= 60 && Buff.PlayerHasActiveBuff("Energizing Brew") && Me.HasMyAura("Tiger Power") && Buff.PlayerBuffTimeLeft("Tiger Power") >= 3, "Blackout Kick w/ FoF"),
