...
namespace CLU.Classes.Warlock
{
    class Affliction : RotationBase
    {
        ...
        {
            return
                new Decorator(ret => Me.CurrentTarget != null && Unit.NearbyAttackableUnits(Me.CurrentTarget.Location, 10).Count() > 1 && Unit.NearbyAttackableUnits(Me.CurrentTarget.Location, 10).Count() < CLUSettings.Instance.Warlock.SeedOfCorruptionCount,
        ...
        {
            return
                new Decorator(ret => Me.CurrentTarget != null && Unit.NearbyAttackableUnits(Me.CurrentTarget.Location, 10).Count() >= CLUSettings.Instance.Warlock.SeedOfCorruptionCount && !HasSeedofCorruption,
                        new Sequence(
                            Spell.CastSpell(27243, onUnit => Me.CurrentTarget, ret => true, "[HandleSeedofCorruptionAoE] Seed of Corruption"),
