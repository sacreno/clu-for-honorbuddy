            ...
            get
            {
                return new PrioritySelector(
                    ...
                    new Decorator(
                        ...
                        new PrioritySelector(Spell.CastSelfSpell("Sprint", ret => Me.IsMoving && Unit.DistanceToTargetBoundingBox() >= 15,"Sprint"),
                    ...
                    Spell.CastSpell("Vendetta", ret => Me.CurrentTarget != null && Unit.IsTargetWorthy(Me.CurrentTarget), "Vendetta"),// with Glyph "Glyph of Vendetta" 9s longer but decrased Damagebuff by 5%
                    ...
                    Spell.CastSpell("Dispatch", ret => Me.CurrentTarget != null && Me.ComboPoints == 4 && Buff.PlayerHasActiveBuff("Blindside"), "Dispatch"),
