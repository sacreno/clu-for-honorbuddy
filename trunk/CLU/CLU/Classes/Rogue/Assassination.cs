            ...
            get
            {
                return new PrioritySelector(
                    ...
                    new Sequence(
                        ...
                        new WaitContinue(1, ret => Me.HasMyAura("Stealth") || Me.HasMyAura("Vanish"),
                                         new ActionAlwaysSucceed()),// Waiting for lag to come by...best thing we can do, i don't want to lock out the whole rotation when we are stealthed
                        Spell.CastSpell("Ambush",
                                        ret =>
                                        Me.CurrentTarget != null && IsBehind(Me.CurrentTarget) &&
                                        SpellManager.HasSpell("Subterfuge"), "Ambush"), //I hope this works this way :/
                        Spell.CastSpell("Ambush", ret => Me.CurrentTarget != null && IsBehind(Me.CurrentTarget),
                                        "Ambush") // Do this when we don't specced in Subterfuge. But if so, then we will maybe get a second Ambush. Needs testing
                        ),
                    // Doin' ya damage
                    ...
                    Spell.CastSpell("Preparation",
                                    ret =>
                                    Me.CurrentTarget != null && Unit.IsTargetWorthy(Me.CurrentTarget) &&
                                    SpellManager.Spells["Vanish"].Cooldown, "Preparation"),// with Glyph "Glyph of Vendetta" 9s longer but decrased Damagebuff by 5%
                    Spell.CastSpell("Dispatch",
                                    ret =>
                                    Me.CurrentTarget != null && Me.ComboPoints == 4 &&
                                    Buff.PlayerHasActiveBuff("Blindside"), "Dispatch"),// No longer behind the freain' target FTW
                    ...
                    Spell.CastSpell("Dispatch",
                                    ret =>
                                    Me.CurrentTarget != null && (BossList.BackstabIds.Contains(Unit.CurrentTargetEntry)) &&
                                    Me.ComboPoints < 5 && Me.CurrentTarget.HealthPercent < 35, "Dispatch"),
