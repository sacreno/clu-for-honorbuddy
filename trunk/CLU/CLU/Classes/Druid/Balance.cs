            ...
            get
            {
                return (
                    new PrioritySelector(
                        ...
                        Spell.CastSelfSpell("Celestial Alignment", ret => (Me.CurrentEclipse <= 0 || Me.CurrentEclipse >= 0) && (Buff.PlayerHasActiveBuff("Incarnation: Chosen of Elune") || !TalentManager.HasTalent(11)), "Celestial Alignment"),
                        ...
                        Spell.CastSpell("Wrath", ret => Common.didICap() && Me.CurrentEclipse <= -70 && Common.eclipseDir() <= 0, "Wrath"),
                        //starfire,if=eclipse>=60&eclipse_dir>=0
                        Spell.CastSpell("Starfire", ret => Common.didICap() && Me.CurrentEclipse >= 60 && Common.eclipseDir() >= 0, "Starfire"),
                        ...
                        Spell.CastSpell("Starfire", ret => Common.didICap() && (Common.eclipseDir() == 1 || (Common.eclipseDir() == 0 && Me.CurrentEclipse > 0)), "Starfire"),
                        //wrath,if=eclipse_dir=-1|(eclipse_dir=0&eclipse<=0)
                        Spell.CastSpell("Wrath", ret => Common.didICap() && (Common.eclipseDir() == -1 || (Common.eclipseDir() == 0 && Me.CurrentEclipse <= 0)), "Wrath"),
