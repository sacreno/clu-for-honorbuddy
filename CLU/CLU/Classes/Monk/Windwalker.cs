            ...
            get
            {
                return new PrioritySelector(
                    // Pause Rotation
                           ...
                           Spell.CastSpell("Rising Sun Kick", ret => !Buff.TargetHasDebuff("Rising Sun Kick") || Buff.PlayerBuffTimeLeft("Tiger Power") < 5 && Buff.PlayerBuffTimeLeft("Tiger Power") > 3 && Me.CurrentEnergy >= 40 || Buff.PlayerBuffTimeLeft("Tiger Power") >= 5, "Rising Sun Kick"),
                           ...
                           Spell.CastSpell("Fists of Fury", ret => !Me.IsMoving && !Buff.PlayerHasActiveBuff("Energizing Brew") && Me.CurrentEnergy <= 50 && Buff.PlayerBuffTimeLeft("Tiger Power") > 5 && Buff.PlayerCountBuff("Tiger Power") == 3 && Spell.SpellCooldown("Rising Sun Kick").TotalSeconds >= 2, "Fists of Fury"),
                           Spell.CastSpell("Blackout Kick", ret => Buff.PlayerHasActiveBuff("Combo Breaker: Blackout Kick"), "Blackout Kick"),
                           Spell.CastSpell("Tiger Palm", ret => (Buff.PlayerHasActiveBuff("Combo Breaker: Tiger Palm") && Me.CurrentEnergy < 90) || (Buff.PlayerBuffTimeLeft("Combo Breaker: Tiger Palm") < 2 && Buff.PlayerHasActiveBuff("Combo Breaker: Tiger Palm")), "Tiger Palm"),
                           Spell.CastSpell("Blackout Kick", ret => Chi >= 2 && Spell.SpellOnCooldown("Fists of Fury") && SpellManager.Spells["Rising Sun Kick"].CooldownTimeLeft.Seconds >= 2 || Chi >= 3 && Me.CurrentEnergy <= 50 && Me.IsMoving && !Spell.SpellOnCooldown("Fists of Fury") && SpellManager.Spells["Rising Sun Kick"].CooldownTimeLeft.Seconds >= 2 || Chi >= 3 && Me.CurrentEnergy > 50 && SpellManager.Spells["Rising Sun Kick"].CooldownTimeLeft.Seconds >= 2, "Blackout Kick"),
                           ...
                           Spell.CastSpell("Jab", ret => Chi <= 2 && Me.HealthPercent > 80 || Chi <= 2 && Spell.SpellOnCooldown("Expel Harm") && Me.HealthPercent <= 80, "Jab"),
