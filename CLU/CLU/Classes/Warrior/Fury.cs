            ...
            get
            {
                return new PrioritySelector(
                    ...
                    // Interupts
                                    ...
                                    Spell.CastSelfSpell("Deadly Calm", ret => CLUSettings.Instance.Warrior.UseDeadlyCalm && Unit.UseCooldowns() && Me.CurrentRage >= 40 && (CLUSettings.Instance.UseAoEAbilities && Unit.EnemyMeleeUnits.Count() < 4 || !CLUSettings.Instance.UseAoEAbilities), "Deadly Calm"),
                    ...
                    //AoE
                                    ...
                                    Spell.CastSpell("Whirlwind", ret => Unit.EnemyMeleeUnits.Count() > 3 && ColossusSmashBloodthirstCooldown && Me.CurrentRage >= (TalentManager.HasGlyph("Unending Rage") ? 60 : 80) && (Buff.PlayerCountBuff("Meat Cleaver") < 3 || Buff.PlayerCountBuff("Meat Cleaver") > 2 && !Buff.PlayerHasActiveBuff("Raging Blow!")), "Whirlwind"),
                                    Spell.CastSpell("Cleave", ret => Me.CurrentTarget != null && Unit.EnemyMeleeUnits.Count() > 1 && Unit.EnemyMeleeUnits.Count() < 4 && CLUSettings.Instance.UseAoEAbilities && ColossusSmashBloodthirstCooldown && !Buff.PlayerHasActiveBuff("Raging Blow!") && (Me.CurrentRage >= (TalentManager.HasGlyph("Unending Rage") ? 60 : 80) || Buff.PlayerHasBuff("Deadly Calm") && Me.CurrentRage >= (TalentManager.HasGlyph("Unending Rage") ? 60 : 40)), "Cleave"),
                    //Single Target
                                    ...
                                    Spell.CastSpell("Raging Blow", ret => CLUSettings.Instance.UseAoEAbilities && Unit.EnemyMeleeUnits.Count() < 4 && Buff.PlayerHasActiveBuff("Raging Blow!") || !CLUSettings.Instance.UseAoEAbilities && Buff.PlayerHasActiveBuff("Raging Blow!"), "Raging Blow"),
                                    Spell.CastSpell("Wild Strike", ret => Me.HasAura(46916) && Me.CurrentTarget.HealthPercent >= 20 && Spell.SpellOnCooldown("Bloodthirst") && (CLUSettings.Instance.UseAoEAbilities && Unit.EnemyMeleeUnits.Count() < 4 || !CLUSettings.Instance.UseAoEAbilities), "Wild Strike"),
