                ...
                return new PrioritySelector(
                    // Pause Rotation
                                ...
                                new Decorator(
                                    ...
                                    Spell.CastSpell("Whirlwind", ret => ColossusSmashBloodthirstCooldown && Me.CurrentRage >= (TalentManager.HasGlyph("Unending Rage") ? 60 : 80) && (Buff.PlayerCountBuff("Meat Cleaver") < 3 || Buff.PlayerCountBuff("Meat Cleaver") > 2 && !Buff.PlayerHasActiveBuff("Raging Blow!")), "Whirlwind"),
                                    Spell.CastSpell("Cleave", ret => Unit.EnemyMeleeUnits.Count() == 2 && ColossusSmashBloodthirstCooldown && Me.CurrentRage >= (TalentManager.HasGlyph("Unending Rage") ? 60 : 40) || Me.CurrentRage >= (TalentManager.HasGlyph("Unending Rage") ? 90 : 110), "Cleave"))),
                                ...
                                //Single Target
                                    ...
                                    Spell.CastSpell("Heroic Strike", ret => Me.CurrentTarget.HealthPercent >= 20 && Me.CurrentRage >= (TalentManager.HasGlyph("Unending Rage") ? 60 : 80), "Heroic Strike"),
                ...
                return new Decorator(
                    ...
                    //Buff.CastBuff("Battle Stance",          ret => StyxWoW.Me.Shapeshift != CLUSettings.Instance.Warrior.StanceSelection && CLUSettings.Instance.Warrior.StanceSelection == ShapeshiftForm.BattleStance, "Stance is Battle"),
                            ...
                            Spell.CastSpell("Charge", ret => Me.CurrentTarget != null && CLU.LocationContext == GroupLogic.Battleground &&
                                (Macro.Manual || Unit.IsTrainingDummy(Me.CurrentTarget)) && Me.CurrentTarget.DistanceSqr > 3.2 * 3.2 && Navigator.CanNavigateFully(Me.Location,Me.CurrentTarget.Location), "Charge"),
