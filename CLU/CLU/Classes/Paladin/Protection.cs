        ...
        public override Composite SingleRotation
        {
            get {
                return new PrioritySelector(
                           ...
                           Spell.CastAreaSpell("Consecration", 10, TalentManager.HasGlyph("Consecration"), CLUSettings.Instance.Paladin.ConsecrationCount, 0.0, 0.0, ret => Me.CurrentTarget != null && !BossList.IgnoreAoE.Contains(Unit.CurrentTargetEntry) && Me.ManaPercent > CLUSettings.Instance.Paladin.ConsecrationManaPercent && TalentManager.HasGlyph("Consecration"), "Consecration (Targeted)"),
