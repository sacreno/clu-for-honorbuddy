        ...
        public override Composite SingleRotation
        {
            get {
                return new PrioritySelector(
                           ...
                           Spell.CastOnGround(110701, ret => Me.CurrentTarget.Location, a => Me.CurrentTarget != null && !BossList.IgnoreAoE.Contains(Unit.CurrentTargetEntry) && Me.ManaPercent > CLUSettings.Instance.Paladin.ConsecrationManaPercent && TalentManager.HasGlyph("Consecration")),
