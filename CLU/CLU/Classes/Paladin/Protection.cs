        ...
        public override Composite SingleRotation
        {
            get {
                return new PrioritySelector(
                           ...
                           Spell.CastSpell("Holy Prism",on=>Me, ret => Me.HealthPercent < CLUSettings.Instance.Paladin.HolyPrismPercent && Me.CurrentTarget != null && Unit.EnemyMeleeUnits.Count() >= CLUSettings.Instance.Paladin.HolyPrismCount, "Holy Prism"),
                           ...
                           Spell.CastSpell("Execution Sentence", ret => Unit.UseCooldowns() && Me.CurrentTarget.HealthPercent >= CLUSettings.Instance.Paladin.ExecutionSentencePercentage, "Execution Sentence"),
