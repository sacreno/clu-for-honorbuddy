            ...
            get
            {
                return (
                    new PrioritySelector(
                        ...
                        Spell.CastSpell("Mind Blast", ret => !Me.IsMoving && Unit.CountEnnemiesInRange(Me.CurrentTarget.Location, 10) <= 6, "Mind Blast"),
                        ...
                        Spell.CastSpell("Vampiric Touch", ret => !Me.IsMoving && !Buff.TargetHasDebuff("Vampiric Touch") || Buff.TargetDebuffTimeLeft("Vampiric Touch").TotalSeconds < 1.26 + 2.52, "Vampiric Touch"),//~> GUI option for tick and cast time
                        ...
                        Spell.CastSpell("Mind Sear", ret => !Me.IsMoving && Unit.CountEnnemiesInRange(Me.CurrentTarget.Location, 10) >= 3, "Mind Sear"),
                        //mind_flay,chain=1,interrupt=1
                        Spell.ChannelSpell("Mind Flay", ret => !Me.IsMoving, "Mind Flay"),
